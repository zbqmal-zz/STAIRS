...
void drawSRGame() {
    ...
    (*(volatile unsigned short *)0x04000010) = SR_hOff;
    (*(volatile unsigned short *)0x04000012) = SR_vOff;
}
    ...
    switch (SRGameState) {
        ...
        case SRRACING:
            ...
            if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0))))) {
                ...
                if (player.screenCol + player.width / 2 >= 240 / 2
                    && SR_hOff + 240 - 1 <= 512)
                    SR_hOff += player.cdel;


                if ((player.worldCol + player.width / 2) > 512) {
...
void drawSRPlayer() {
    ...
    shadowOAM[47].attr0 = player.screenRow | (1<<14);
    shadowOAM[47].attr1 = player.screenCol | (2<<14);
    shadowOAM[47].attr2 = ((22)*32+(12 + 4 * player.aniState));
}
...
void initSRComputers() {
    ...
    for (int i = 0; i < 2; i++) {
        ...
        SRComputers[i].aniCounter = rand() % 20 + 1;
...
void updateSRComputer(ANISPRITE * computer) {
    ...
    switch (SRGameState) {
        ...
        case SRRACING:
            ...
            if (computer->worldCol + computer->width / 2 >= 512) {
...
void drawSRComputer(ANISPRITE* computer) {
    ...
    if (computer->worldCol >= SR_hOff
        && (computer->worldCol <= SR_hOff + 240 - 1)) {

        shadowOAM[computer->index + 48].attr0 = computer->screenRow | (1<<14);
        shadowOAM[computer->index + 48].attr1 = computer->screenCol | (2<<14);
        shadowOAM[computer->index + 48].attr2 = ((24 + 2 * computer->index)*32+(12 + 4 * computer->aniState));

    } else {

        shadowOAM[computer->index + 48].attr0 = (2<<8);
    }
}
...
void drawSRGameSet() {
    ...
    shadowOAM[15].attr0 = 20 | (1<<14);
    shadowOAM[15].attr1 = (240 / 2 - 16) | (2<<14);
    if (isSRPlayerWin)
        shadowOAM[15].attr2 = ((30)*32+(16));
    else
        shadowOAM[15].attr2 = ((28)*32+(16));
