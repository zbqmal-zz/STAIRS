...
extern ANISPRITE playerSelect, bushes[9], treasure;
...
ANISPRITE playerSelect, bushes[9], treasure;
...
void drawTHGame() {
    ...
    (*(volatile unsigned short *)0x04000010) = TH_hOff;
    (*(volatile unsigned short *)0x04000012) = TH_vOff;
}
...
void drawBush(ANISPRITE* bush) {
    ...
    if (bush->active) {
        shadowOAM[bush->index + 16].attr0 = bush->screenRow | (0<<14);
        shadowOAM[bush->index + 16].attr1 = bush->screenCol | (2<<14);
        shadowOAM[bush->index + 16].attr2 = ((4)*32+(24));
    } else {
        shadowOAM[bush->index + 16].attr0 = (2<<8);
    }
}
...
void drawTreasure() {
    ...
    shadowOAM[25].attr0 = treasure.screenRow | (0<<14);
    shadowOAM[25].attr1 = treasure.screenCol | (2<<14);
    shadowOAM[25].attr2 = ((8)*32+(24));
}
...
void updateSelect() {
    ...
    if (THGameState == THCHOOSING) {
        ...
        if ((!(~(oldButtons)&((1<<9))) && (~buttons & ((1<<9)))) && playerLives == 5) {
            playerLives = 8;
        }


        if ((!(~(oldButtons)&((1<<6))) && (~buttons & ((1<<6)))) && (playerSelect.screenRow > 30) ) {
        ...
        if ((!(~(oldButtons)&((1<<7))) && (~buttons & ((1<<7)))) && (playerSelect.screenRow < 96)) {
        ...
        if ((!(~(oldButtons)&((1<<5))) && (~buttons & ((1<<5)))) && (playerSelect.screenCol > 70)) {
        ...
        if ((!(~(oldButtons)&((1<<4))) && (~buttons & ((1<<4)))) && (playerSelect.screenCol < 136)) {
        ...
        if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0)))) && bushes[playerSelect.index].active) {
            ...
            if (playerSelect.index == treasure.index) {
                ...
                stopSoundB();
                playSoundB(THFailSound, 4320, 11025, 0);
            }
            ...
            if (playerLives == 0) {
                ...
                if (!isFound) {
                    ...
                    stopSoundB();
                    playSoundB(THLoseSound, 46368, 11025, 0);
                }
...
void drawSelect() {
    ...
    shadowOAM[26].attr0 = playerSelect.screenRow | (0<<14);
    shadowOAM[26].attr1 = playerSelect.screenCol | (2<<14);
    shadowOAM[26].attr2 = ((28)*32+(12));
}

void drawTHGameSet() {


    shadowOAM[15].attr0 = 10 | (1<<14);
    shadowOAM[15].attr1 = 10 | (2<<14);
    shadowOAM[15].attr2 = ((28 + 2 * isFound)*32+(16));


    shadowOAM[36].attr0 = 30 | (0<<14);
    shadowOAM[36].attr1 = 30 | (1<<14);
