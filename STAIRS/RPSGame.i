...
void drawRPSGame() {
    ...
    (*(volatile unsigned short *)0x04000010) = RPS0_hOff;
    (*(volatile unsigned short *)0x04000012) = RPS0_vOff;
    (*(volatile unsigned short *)0x04000014) = RPS1_hOff;
    (*(volatile unsigned short *)0x04000016) = RPS1_vOff;
}
...
void drawRPSEnemy() {
    ...
    if (enemy.screenCol <= 240) {
        shadowOAM[9].attr0 = enemy.screenRow | (0<<14);
        shadowOAM[9].attr1 = enemy.screenCol | (2<<14);
        shadowOAM[9].attr2 = (((12 + 4 * enemy.curFrame))*32+((4 + enemy.aniState * 4)));
    }
}
...
void updateNOTREADY() {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5))) || (~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        ...
        if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
            ...
            if (player.worldCol - player.cdel >= 0) {
                ...
                if (player.screenCol <= 240 / 2) {
                    enemy.screenCol += 1;
                }


                if ((RPS0_hOff - player.cdel >= 0) && (player.screenCol <= 240 / 2)) {
        ...
        if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
            ...
            if (player.worldCol + (player.width - 1) + player.cdel < 450) {
                ...
                if ((player.screenCol >= 240 / 2) && ((RPS0_hOff + 240) + player.cdel <= 512)) {
                    RPS0_hOff += player.cdel;
                    RPS1_hOff += 1;
                }
    ...
    if (player.worldCol > 420) {
        ...
        shadowOAM[35].attr0 = (player.screenRow - 16) | (0<<14);
        shadowOAM[35].attr1 = (player.screenCol - 16) | (1<<14);
        shadowOAM[35].attr2 = ((28)*32+(28));


        if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0)))) && player.worldCol > 420) {
...
void updateREADY() {
    ...
    if ((!(~(oldButtons)&((1<<5))) && (~buttons & ((1<<5)))) && playerWeapon > 0) {


        stopSoundB();
        playSoundB(choosingSound, 1314, 11025, 0);

        playerPick.screenCol -= 32;
        playerWeapon--;
    }
    if ((!(~(oldButtons)&((1<<4))) && (~buttons & ((1<<4)))) && playerWeapon < 2) {
        ...
        if (playerWeapon == ROCK) {
            ...
            switch (enemyWeapon) {
                ...
                case ROCK:
                    ...
                    playSoundB(RPSDrawSound, 14865, 11025, 0);


                    shadowOAM[15].attr0 = 15 | (1<<14);
                    shadowOAM[15].attr1 = 105 | (2<<14);
                    shadowOAM[15].attr2 = ((28)*32+(24));


                    shadowOAM[14].attr0 = playerScissors.screenRow | (0<<14);
                    shadowOAM[14].attr1 = (playerScissors.screenCol + 64) | (2<<14);
                    shadowOAM[14].attr2 = ((28)*32+(4 * enemyWeapon));
                    break;

                case PAPER:


                    playSoundB(RPSLoseSound, 40896, 11025, 0);
                ...
                case SCISSORS:
                    ...
                    playSoundB(RPSWinSound, 22464, 11025, 0);
...
void drawREADY() {
    ...
    shadowOAM[10].attr0 = playerRock.screenRow | (0<<14);
    shadowOAM[10].attr1 = playerRock.screenCol | (2<<14);
    shadowOAM[10].attr2 = ((28)*32+(0));


    shadowOAM[11].attr0 = playerPaper.screenRow | (0<<14);
    shadowOAM[11].attr1 = playerPaper.screenCol | (2<<14);
    shadowOAM[11].attr2 = ((28)*32+(4));


    shadowOAM[12].attr0 = playerScissors.screenRow | (0<<14);
    shadowOAM[12].attr1 = playerScissors.screenCol | (2<<14);
    shadowOAM[12].attr2 = ((28)*32+(8));


    shadowOAM[13].attr0 = playerPick.screenRow | (0<<14);
    shadowOAM[13].attr1 = playerPick.screenCol | (2<<14);
    shadowOAM[13].attr2 = ((28)*32+(12));
}
...
void drawGAMESET() {
    ...
    shadowOAM[15].attr0 = 15 | (1<<14);
    shadowOAM[15].attr1 = 105 | (2<<14);
    shadowOAM[15].attr2 = ((28 + 2 * isRPSPlayerWin)*32+(16));


    shadowOAM[35].attr0 = (2<<8);
    shadowOAM[36].attr0 = (player.screenRow - 16) | (0<<14);
    shadowOAM[36].attr1 = (player.screenCol - 16) | (1<<14);
