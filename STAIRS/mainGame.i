...
enum {START, RECORD, INSTRUCTION, MAINGAME, STAGEINTRO, RPSGAME, THGAME, PAROMAGAME, SRGAME, PAUSE, END};
# 302 "myLib.h"
...
# 1 "gameEntranceSound.h" 1
# 20 "gameEntranceSound.h"
extern const unsigned char gameEntranceSound[23040];
# 6 "mainGame.h" 2
# 1 "rollingDiceSound.h" 1
# 20 "rollingDiceSound.h"
extern const unsigned char rollingDiceSound[23040];
# 7 "mainGame.h" 2
# 1 "walkingSound.h" 1
# 20 "walkingSound.h"
extern const unsigned char walkingSound[14663];
# 8 "mainGame.h" 2
...
void drawMainGame() {
    ...
    (*(volatile unsigned short *)0x04000010) = MG0_hOff;
    (*(volatile unsigned short *)0x04000012) = MG0_vOff;
    (*(volatile unsigned short *)0x04000014) = MG1_hOff;
    (*(volatile unsigned short *)0x04000016) = MG1_vOff;
    (*(volatile unsigned short *)0x04000018) = MG2_hOff;
    (*(volatile unsigned short *)0x0400001A) = MG2_vOff;
}
        ...
        if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5))) || ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4))))) {
            ...
            if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
                ...
                if ((player.worldCol - player.cdel) >= 16) {
                    ...
                    if (!walkingSoundFlag) {
                        ...
                        walkingSoundFlag = 1;
                        stopSoundB();
                        playSoundB(walkingSound, 14663, 11025, 1);
                    }
                    ...
                    if (MG0_hOff - player.cdel > 0 && player.screenCol < 240 / 2) {
            ...
            if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
                ...
                if ((player.worldRow - player.rdel) >= destRow) {
                    ...
                    if (player.screenCol > 240 / 2 && MG0_hOff + 240 <= 512) {
...
void drawMGPlayer() {
    ...
    shadowOAM[6].attr0 = player.screenRow | (2<<14);
    shadowOAM[6].attr1 = player.screenCol | (2<<14);
    shadowOAM[6].attr2 = (((player.curFrame * 4))*32+((4 + 2 * player.aniState)));
}
    ...
    if (isRolled) {
        ...
        if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0))))) {
            ...
            if (!isRolling) {
                ...
                stopSoundB();
                playSoundB(rollingDiceSound, 23040, 11025, 0);
                isRolling = 1;
...
void drawDice() {
    ...
    shadowOAM[8].attr0 = dice.screenRow | (0<<14);
    shadowOAM[8].attr1 = dice.screenCol | (2<<14);
    shadowOAM[8].attr2 = ((diceNum * 4)*32+(28));
    ...
    if (isRolled) {
        ...
        if (isAtDoor) {
            ...
            shadowOAM[36].attr0 = (dice.screenRow + (dice.width + 2)) | (0<<14);
            shadowOAM[36].attr1 = (dice.screenCol + (dice.height + 3)) | (1<<14);
            shadowOAM[36].attr2 = ((28)*32+(30));
        ...
        shadowOAM[35].attr0 = (dice.screenRow + (dice.width + 2)) | (0<<14);
        shadowOAM[35].attr1 = (dice.screenCol + (dice.height + 3)) | (1<<14);
        shadowOAM[35].attr2 = ((28)*32+(28));
    }
}
...
void drawDoor() {
    ...
    if (isRolled && door.screenRow >= 0 && door.screenCol <= 240) {


        shadowOAM[37].attr0 = (door.screenRow + 1) | (0<<14);
        shadowOAM[37].attr1 = door.screenCol | (2<<14);
        shadowOAM[37].attr2 = ((28)*32+(20));
    } else {
...
void drawLevel() {
    ...
    shadowOAM[38].attr0 = (player.screenRow + 24) | (0<<14);
    shadowOAM[38].attr1 = (player.screenCol) | (0<<14);
    shadowOAM[39].attr0 = (player.screenRow + 24) | (0<<14);
    shadowOAM[39].attr1 = (player.screenCol + 8) | (0<<14);
    shadowOAM[40].attr0 = (player.screenRow + 24) | (0<<14);
    shadowOAM[40].attr1 = (player.screenCol + 16) | (0<<14);
    if (player.worldRow >= 210 - 16 * 0) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 0) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 0) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 0) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 1) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 1) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 1) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 1) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 2) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 2) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 2) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 2) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 3) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 3) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 3) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 3) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 4) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 4) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 4) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 4) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 5) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 5) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 5) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 5) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 6) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 6) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 6) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 6) % 10)))*32+(27));

    } else if (player.worldRow >= 242 - 16 * 7) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 7) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 7) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 7) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 8) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 8) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 8) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 8) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 9) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 9) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 9) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 9) % 10)))*32+(27));

    } else if (player.worldRow >= 210 - 16 * 10) {
        shadowOAM[38].attr2 = ((12 + (((currentLevel + 10) % 1000) / 100))*32+(27));
        shadowOAM[39].attr2 = ((12 + (((currentLevel + 10) % 100) / 10))*32+(27));
        shadowOAM[40].attr2 = ((12 + (((currentLevel + 10) % 10)))*32+(27));
    }
